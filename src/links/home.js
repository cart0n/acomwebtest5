    ...
    <section className="third-page container">
        ...
        <div class="districts">
            <div class="districts-items">
                <div class="end"><div><img src="images/hys.png" alt="" /><p>Гусятинський район</p></div></div>
                <div class="center"><div><img src="images/shymsk1.png" alt="" /><p>Шумський район</p></div></div>
                <div class="start"><div><img src="images/zbar.png" alt="" /><p>Збаразький район</p></div></div>
            </div>
            <div class="districts-items">
                <div class="start"><div><img src="images/lan.png" alt="" /><p>Лановецький район</p></div> </div>
                <div class="center"><div><img src="images/borshch.png" alt="" /><p>Борщівський район</p></div></div>
                <div class="end"><div><img src="images/zalish.png" alt="" /><p>Заліщицький район</p></div></div>
            </div>
        </div>
    </section>
    <footer className="container into-footer">
        ...
        <div className="main-footer" id="main-footer">
            ...
            <div class="footer-section">
                <h3>Контакти</h3>
                <p><i className="fas fa-map-marker-alt"></i>Тернопіль вулиця А дім B</p>
