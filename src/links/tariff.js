        ...
        <div class="container tariffs">
            ...
            <article class="main-tariffs">
                ...
                <div className='tafiff-rows'>
                    ...
                    <label for="accordion-1" class="accordion-item-trigger">Борщівський район</label>
                    ...
                    <label for="accordion-2" class="accordion-item-trigger">Гусятинський район</label>
                    <div className="accordion-item-content">
                    <div className="tariff-boxes">
                    ...
                    <label for="accordion-3" className="accordion-item-trigger">Збаразький район</label>
                    <div className="accordion-item-content">
                        <div className="tariff-boxes">
                            <div  class="tariff-box" id="tb1">
                                <div class="tariff-box-inside">
                    ...
                    <label for="accordion-4" class="accordion-item-trigger">Ланівецький і Шумський райони</label>
                    <div className="accordion-item-content">
